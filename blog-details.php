...
<section class="common-box blog-detail-page blog-page" role="main">
    <div class="container">
        <div class="page-title">
            <h1>
                Everest Base Camp Trekking Expedition Guide Himalayan Adventure Travel Blog for Hikers and Nature Lovers
            </h1>
        </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4 blog-author">
                    ...
                    <div class="blog-author__content">
                        <div class="text-lg font-bold text-primary font-signika ">Dipesh Gurung</div>
                        <div class="text-sm text-text_color opacity-80">Updated on April 27, 2024</div>
                    </div>
                </div>
                <div class="blog-share">
                    <div class="share-wrap" id="shareDropdown">
                        <button id="sharetoggle" class="share-trigger-btn">
                            <span class="text-xl icon-share"> </span>
                ...
                <div class="col-span-12 lg:col-span-10">
                    ...
                    <article>
                        ...
                        <p>
                            ...
                            mi vitae est. Mauris placerat eleifend leo. Pellentesque
                ...
                <div class="col-span-12">
                    <div class="grid grid-cols-12 gap-5 mt-6">
                        <div class="col-span-12 lg:col-span-8">
                            <article class="js-toc-content">
                                ...
                                <div class="mb-5 offer-package">
                                    <div class="relative flex items-center gap-5 offer-package__item  rounded-[5px]  border border-[#ffe3d2] px-5 py-4 mb-5 last:mb-0">
                                        ...
                                        <div class="w-full offer-package__item-content">
                                            <div class="flex flex-wrap items-center gap-3 mb-3 offer-package__item-meta">
                                                <div class="package-tag font-normal text-sm text-text_color bg-primary/20 px-4 py-1 rounded-[30px] ">Featured</div>
                                                <div class="flex items-center gap-2">
                                                    <div class="icon-star"></div>
                                                    <span class="text-sm font-semibold text-text_color">
                                                        4.9 (4 Reviews)
                                                    </span>
                                                </div>
                                                <div class="flex items-center gap-2">
                                                    <div class="text-xl icon-calendar-month"></div>
                                                    <span class="text-sm font-semibold text-text_color">
                                                        15 Days
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="mb-4 offer-package__item-title">
                                                <a
                                                    href=""
                                                    class="text-xl font-extrabold transition-all duration-500 font-signika text-primary font-barlow hover:text-secondary">
                            ...
                            <hr class="mt-8 border-t border-primary border-opacity-10" />
                            <div class="flex flex-wrap gap-1 mt-8 mb-8 blog__category-list">
                                <a
                                    class="blog__category-list-item"
                                    href="/">
                                    Nepal Travel Guide
                                </a>
                                <a
                            ...
                            <div class="  mt-5 rounded-[5px] bg-[#fff9f6]  px-4 py-8 text-center">
                                <span class="block text-text_color font-signika">
                                    Call us on WhatsApp
                                </span>
                                <span class="block text-lg font-bold text-primary">
                                    <a
                                        href="https://wa.me/9779851012345"
                                        class="inline-block px-2 transition-all duration-500 hover:text-secondary text-primary"
                                        target="_blank"
                                        rel="noreferrer">
                                        +977 9851012345
                                    </a>
                                ...
                                <div
                                    class="hidden w-125 max-w-125  rounded-[5px] "
                                    id="send-inquiry">
                            ...
                            <div class="flex items-center py-10 blog__nav">
                                <div class="blog__nav-prev">
                                    <a href="">
                                        <div class="flex items-center justify-start gap-5 sm:pr-10">
                                            ...
                                            <div class="blog__nav-prev-content">
                                                ...
                                                <div class="flex items-center gap-2 text-xs uppercase transition-all duration-500 text-text_color hover:text-primary">
                                                    <span class="w-4 h-2 rotate-180 icon-arrow-right"></span>
                                                    Previous post
                                                </div>

                                                <div class="inline-block   text-lg font-bold leading-5! transition-all duration-500 blog__nav-title hover:text-primary text-text_color">
                                                    Discover the river and its people in our latest
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="blog__nav-next">
                                    <a href="">
                                        <div class="flex items-center justify-end gap-5 sm:pl-10">
                                            <div class="blog__nav-next-content">
                                                <div class="flex items-center justify-end gap-2 text-xs uppercase transition-all duration-500 text-text_color hover:text-primary">
                                                    Next post
                                                    <span class="w-4 h-2 icon-arrow-right"></span>
                                                </div>
                                                <div class="inline-block   text-lg font-bold leading-5! text-right transition-all duration-500 blog__nav-title hover:text-primary text-text_color">
                                                    Discover the river and its people in our latest
                                                </div>
                                            </div>
                                            <div class="blog__nav-next-img">
                                                <div class="placeholder__img-wrapper">
                                                    <div class="placeholder__img">
                                                        <img
                                                            src="/images/dynamic/blog-thumb.webp"
                            ...
                            <aside
                                ...
                                <div id="toggleButton">
                                    <span class="show-icon">
                                        <span class="text-3xl icon-blog-toc"></span>
                                    </span>
                                ...
                                <div
                                    class="toc-list-wrapper my-6 rounded-r-[5px] border-t-4 border-primary bg-dim_bg p-4 px-6 py-5 shadow">
                                    <span class="block mb-4 text-xl font-bold text-primary font-signika ">
                                        Table of Contents
                                    </span>
    ...
    <div class="pb-6 recent-blog__wrapper blog-list scroll-wrap ">
        <div class="container">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        window.addEventListener("resize", handleScrollButton);
