...
<section class="common-box booking-page" role="main">
    <div class="container">
                    ...
                    <div class="grid grid-cols-12 gap-3.75">
                        <div class="col-span-12 lg:col-span-8">
                            <form class="floating-form">
                                <div class="border border-primary/30 mb-4 rounded-[5px] bg-white px-6 py-5">
                                    ...
                                    <div class="grid grid-cols-1 gap-1 md:grid-cols-2 md:gap-2">
                                        <div class="relative w-full group">
                                            ...
                                            <label
                                                for="date"
                                                class="absolute pl-3 text-base duration-300 origin-left transform scale-75 -translate-y-3 top-3 text-text_color focus:pl-0 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-3 peer-focus:scale-75 peer-focus:text-text_color rtl:peer-focus:translate-x-1/4 peer-focus:dark:text-text_color">
                                                Pickup Date<span class="text-red-700">*</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center w-full px-3 border custom-rounded border-[#dedede]">
                                ...
                                <div class="border border-primary/30 mb-4 rounded-[5px] bg-white px-6 py-5">
                                    <div class="pb-3 text-lg font-bold border-b border-text_color/20 text-text_color">
                                        Add-Ons and Extra Options
                                    </div>

                                    <div class="grid grid-cols-1 gap-2 pb-4 mt-4 border-b border-dashed border-secondary/30 md:grid-cols-2 md:gap-10">
                                        ...
                                        <div class="flex flex-col items-start justify-between w-full gap-2 md:flex-row md:items-center">
                                            ...
                                            <div class="justify-center flex w-full gap-4 rounded-[5px] border px-2 lg:w-2/4 border-[#dedede]">
                                                <div class="flex items-center gap-2 counter-input">
                                                    <span class="cursor-pointer icon-minus"></span>
                                                    <input type="number" min="1" value="1">
                                                    <span class="cursor-pointer icon-plus"> </span>
                                    ...
                                    <div class="grid grid-cols-1 gap-2 mt-4 md:grid-cols-2 md:gap-10">
                                        ...
                                        <div class="flex flex-col items-start justify-between w-full gap-2 md:flex-row md:items-center">
                                            ...
                                            <div class="justify-center flex w-full gap-4 rounded-[5px] border lg:w-2/4 border-[#dedede]">
                                                <div class="flex items-center gap-2 counter-input">
                                                    <span class="cursor-pointer icon-minus"></span>
                                                    <input type="number" min="1" value="1">
                                                    <span class="cursor-pointer icon-plus"> </span>
                                ...
                                <div class="border border-primary/30 mb-4 rounded-[5px] bg-white px-6 py-5">
                                    ...
                                    <div class="relative z-0 w-full mb-5">
                                        ...
                                        <label
                                            for="extrainfo"
                                            class="absolute pl-3 text-base duration-300 origin-left transform scale-75 -translate-y-3 top-3 focus:pl-0 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-3 peer-focus:scale-75 peer-focus:text-text_color rtl:peer-focus:translate-x-1/4 peer-focus:dark:text-text_color">
                                    ...
                                    <div class="flex items-center mb-5 coupon-apply-wrapper gap-2 md:max-w-[40%]">
                                        ...
                                        <button class="inline-block px-5 py-3.5 text-sm font-semibold text-white  hover:bg-secondary transition-all duration-500 custom-rounded bg-primary">Apply</button>
                                    </div>
                                    ...
                                    <button class="inline-block px-5 py-2.5 text-sm font-semibold text-white transition-all duration-500 hover:bg-primary custom-rounded bg-secondary">
                                        Proceed to Payment
                                    </button>
                                </div>
                            </form>
                            <div class="mt-5 rounded-[5px] border border-secondary/20 px-4 py-3 flex items-center justify-between">
                        ...
                        <div class="col-span-12 lg:col-span-4">
                            <div class="custom-shadow booking-info sticky top-20 rounded-[5px] bg-white">
                                <div class="booking-info__title rounded-t-[5px] bg-primary p-3 font-barlow text-base   font-signika   font-bold text-white sm:text-lg">
                                    Your Trip Details
                                </div>
                                <div class="px-6 py-5 booking-info__body">
                                    <div class="flex items-center gap-3 rounded-[5px] booking-info__package">
                                        ...
                                        <div class="booking-info__package-content">
                                            <div class="font-semibold leading-5 font-signika text-secondary">
                                    ...
                                    <div class="booking-info__breakdown">
                                    ...
                                    <div class="pb-4 mb-3 border-b border-dashed border-secondary/30">
                                    ...
                                    <div class="pb-4 mb-3 border-b">
                                        ...
                                        <div class="flex justify-between gap-3 py-2">
                                            <div class="flex-[0_0_50%] text-right text-sm font-semibold text-primary md:text-base">
                                                Total Price:
                                            </div>
                                            <div class="text-sm font-semibold text-primary md:text-base">
                                                US$1800
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-2 text-xs border custom-rounded border-primary bg-dim_bg text-text_color leading-5!">
                                        The balance of US$1440 is payable online before the trip
                                        start date, or upon arrival.
                                    </div>
                                    <div class="flex gap-3 mt-4">
                                        <span class="block text-sm text-text_color leading-5!">
                                            3D secure and safe checkout. Your credit card details
                                            are safe.
                                            <PaymentsIcon class="mt-3 h-8.75 w-47.5" />
                                        </span>
                                    </div>
                                </div>
                            </div>
