...
<section class="common-box faqs-page" role="main">
    <div class="container">
        ...
        <div class="faqs-page__wrapper ">
            <div class="mb-8 accordion-wrapper last:mb-5">
                <div class="text-2xl font-bold text-primary font-signika ">FAQ mini title</div>
                <div class="accordion" id="faqAccordion">
                    <div class="accordion__item" data-id="q1">
                        <div class="text-xl font-bold accordion__item-title font-signika text-text_color">Lorem ipsum dolor sit amet consectetur, adipisicing elit. </div>
